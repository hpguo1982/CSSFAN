...
backend_args = None
data_root = '/home/xuchenglong1/code/mmdetection-main/dataset/NEU-DET-200/'
...
test_evaluator = dict(
    ann_file=
    '/home/xuchenglong1/code/mmdetection-main/dataset/NEU-DET-200/annotations/instances_val2017.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
    ...
    dataset=dict(
        dataset=dict(
            ...
            pipeline=[
                dict(backend_args=None, type='LoadImageFromFile'),
                dict(type='LoadAnnotations', with_bbox=True),
                dict(keep_ratio=True, scale=[(1333, 640,), (1333, 800,)],
                     type='RandomResize'),
